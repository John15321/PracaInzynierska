...
Wybrany szablon przygotowuje nam wiele narzędzi takie jak na przykład \lcode{mkdcos}, narzędzie służące do generowania dokumetnacji w języku \textbf{Markdown}.
...
Owy plik znajduje się w nowo powstałym folderze \lcode{dist} w \textbf{root}'cie projektu:
...
Następnie za pomocą narzędzia \lcode{twine} uploadujemy wygenerowany plik do indeksu \textbf{PyPI}:
...
Aby sprawdzić czy paczka została poprawnie dodana do globalnego indeksu \textbf{PyPI} w nowym środowisku możemy spróbować zainstalować paczkę \lcode{sgai} w następujący sposób:
